...
SELECT SP_ID, 1, 'Gate Fee', 6000000, 0.025 FROM new_project
UNION ALL
SELECT SP_ID, 1, 'Recyclable', 55740, 0 FROM new_project
UNION ALL
SELECT SP_ID, 1, 'Energy', -4875621, 0 FROM new_project
UNION ALL
SELECT SP_ID, 2, 'O&M Variable', 2250000, 0.025 FROM new_project
UNION ALL
SELECT SP_ID, 2, 'O&M Fixed', 0, 0.025 FROM new_project;